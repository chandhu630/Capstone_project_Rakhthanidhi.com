    ...
    return(
        <div>
            ...
            <div className="IncreasebloodDonation_flex">
                <p className="Increase_Introduction">
                <h2 className="IncreaseHeading">How to increase bloodcells</h2>
                 ...
                 diet or lifestyle. Here are some general tips:</p>
                 <div className="video">
                    <iframe
                        width="400"
                        height="250"
            ...
            <div className="IncreasebloodDonation_flex_one" >
                <div className="Increase_Introduction_one" >
                    ...
                    <ul><li>Staying well-hydrated is essential for overall health and can support the proper functioning of blood cells.</li></ul>
                </div>
                <div className="cina"><img className="cina" src= "https://www.imu.edu.my/wp-content/uploads/2022/03/superfoods-1536x1204.jpg" alt = " " /></div>
            </div>
            ...
            <div className="IncreasebloodDonation_flex_two">
                ...
                <div className="image_All"> <img className="image_All" src= "photos/excercise.jpeg" alt ="" /></div>
            </div>
